...
const PlasmaDonors = (props) => {
    ...
    return (
        <>
            <h1 style={styles.head}>Plasma Donors</h1>
            {data.filter(element => element.nameOfResource == "plasmaDonors").map((element, index) => <div style={styles.items}>
