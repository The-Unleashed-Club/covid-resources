...
const WomenInCardiology = (props) => {
    ...
    return (
        <>
            <h1 style={styles.head}>Women In Cardiology</h1>
            {data.filter(element => element.nameOfResource == "womenInCardiology").map((element, index) => <div style={styles.items}>
...
export default WomenInCardiology