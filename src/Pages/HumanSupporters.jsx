...
const HumanSupporters = (props) => {
    ...
    return (
        <>
            <h1 style={styles.head}>Human Supporters</h1>
            {data.filter(element => element.nameOfResource == "humanSupporters").map((element, index) => <div style={styles.items}>
...
export default HumanSupporters